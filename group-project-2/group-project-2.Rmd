...
Viewing the first six rows of our new data frame, we can see the structure of these data: \vspace{6mm}

```{r view structure of new dataset, echo=FALSE,  warning=FALSE, results="markup"}
...
```{r map_us_demo, results="markup", fig.cap="Demographic distribution in America \\label{fig:map}"}
