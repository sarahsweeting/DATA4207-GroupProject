...
This statement that population density is more significant to indicating case numbers can be proved statistically. 

```{r see the significance of proportiona of 65+, fig.align='center'}
...
As seen above, compared to the other two variables, population density is siginificant at indicating new cases. 

Below is an interactive graph that demonstrates and displays the top 100 counties and their standardised new covid cases over 2020 - 2021. It can be identified visually the different Covid-waves/influxes in cases with the larger the circle the larger higher the number of cases. Hover your mouse to see the county name. 
...
```{r fig.align='center'}
plot_ly(county.covid_long_top_df,
               x = ~long,
               y = ~lat,
               frame = ~year_month,
               ids = ~GEOID,
