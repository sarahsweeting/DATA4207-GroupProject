...
top_65 <- county.data %>%
  arrange(desc(Total_age65plus/POP_ESTIMATE_2018)) %>%
  select(FIPS, '65plus%' = Total_age65plus/POP_ESTIMATE_2018, Area_Name)  %>%
  head(20)
...
```{r}
Density_Cross = inner_join(top_65, top_deaths, by = c('FIPS' = 'FIPS'))
```
