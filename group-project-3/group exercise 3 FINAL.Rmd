...
us.shape.2 <- full_join(us.shape.2,
  covid.data %>%
    dplyr::select(county, avg.dec.temp, avg.jan.temp, avg.feb.temp, avg.mar.temp, avg.apr.temp, avg.may.temp, avg.jun.temp, avg.jul.temp, avg.aug.temp, avg.sep.temp, avg.oct.temp, avg.nov.temp)) %>%
